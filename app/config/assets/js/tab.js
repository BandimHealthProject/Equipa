...
function initButtons() {
    ...
    $.each(tabs, function() {
        ...
        btn.on("click", function() {
            var queryParams = util.setQuerystringParams(date, that.reg, that.regNome, that.hcarea, that.hcareaNome, that.listGroup, that.tab, that.tabNome, null, null, assistant); //2 3->2
